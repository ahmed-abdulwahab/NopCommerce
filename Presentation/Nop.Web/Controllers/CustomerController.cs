...
namespace Nop.Web.Controllers
{
    ...
    public partial class CustomerController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> Register(RegisterModel model, string returnUrl, bool captchaValid, IFormCollection form)
        {
            ...
            const string clientId = "23047e6f-c359-4cb3-8dcd-4f08373fead5",
                        clientSecret = "pyH8Q~fLdAZzp5S9LI46W-Ab9eSZxWl7pZHbnaay",
                        environment = "tllinterview.crm4";
            //check whether registration is allowed
            if (_customerSettings.UserRegistrationType == UserRegistrationType.Disabled)
                return RedirectToRoute("RegisterResult", new { resultId = (int)UserRegistrationType.Disabled, returnUrl });
            ...
            if (ModelState.IsValid)
            {
                ...
                var contactId = await _crmService.GetContactIdByEmailAsync(model.Email);
                ...
                //using var serviceClient = new ServiceClient(new Uri("https://tllinterviews.crm4.dynamics.com/apps/CS"),clientId,clientSecret,true);

                //var accountsCollection = await serviceClient.RetrieveMultipleAsync(new QueryExpression("contact"));
                //var account = new Entity("contact");
                //account["First Name"] = "Contoso";
                //account["Last Name"] = "samts";
                //account["Email"] = "contososamts@gmail.com";
                //await serviceClient.CreateAsync(account);

                //var s =string.Join("\n",
                //    accountsCollection.Entities
                //        .Select(x => $"{x.GetAttributeValue<string>("Email")}, {x.Id}"));
                ...
                if (registrationResult.Success)
                {
                    ...
                    await _crmService.CreateContactAsync(firstName, lastName, model.Email);
                    //properties
